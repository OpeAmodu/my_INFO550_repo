...
In my model, expenses would be the outcome. I will produce a report of exploratory data analysis that would help identify predictors of a person's probable medical expenses. These predictors can be used to
develop a Machine Learning Model that predict a person's probable health care expenses using other variables in the dataset.
